# Generated by Powerlevel10k configuration wizard on 2025-11-25 at 16:54 GMT.
...
() {
  ...
  # Disabled to prevent potential resize artifacts
  ...
  # Disabled to prevent resize artifacts on Foot terminal
